...
### logo
(if applicable) The official master 
logo associated with that topic. You must have permission to use this logo. If no official logo exists, do not include an image.
...
### created_by
(if applicable) mclizz GitHub username of the person and/or organization that authored the collection.
